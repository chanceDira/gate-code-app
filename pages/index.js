...
{/* <div className=''> */}
        ...
        <div className='px-4 my-2'>To get access to your gate code you will use your github account</div> 

        <div className='flex flex-col justify-center items-center'>    
        <div>
          {session ? 
            <img className=' w-20 h-20 rounded-full my-2' src={`${session?.user?.image}`} alt='alt' />
          : ''}
        </div> 
        <div>
        {session?.user?.name}
